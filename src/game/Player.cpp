...
bool Player::LoadFromDB(ObjectGuid guid, SqlQueryHolder *holder )
{
    ...
    //"health, power1, power2, power3, power4, power5, power6, power7, specCount, activeSpec, exploredZones, equipmentCache, ammoId, knownTitles, actionBars, ArenaPointsSinceLastReset  FROM characters WHERE guid = '%u'", GUID_LOPART(m_guid));
	...
	SetArenaPointsSinceLastReset(fields[65].GetUInt32());
	/* Limite de points d'arène quotidiens - By MacWarrior */
...
void Player::SaveToDB()
{
    ...
    SqlStatement uberInsert = CharacterDatabase.CreateStatement(insChar, "INSERT INTO characters (guid,account,name,race,class,gender,level,xp,money,playerBytes,playerBytes2,playerFlags,"
        ...
        "power4, power5, power6, power7, specCount, activeSpec, exploredZones, equipmentCache, ammoId, knownTitles, actionBars, ArenaPointsSinceLastReset) "
        "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, "
        "?, ?, ?, ?, ?, ?, "
        "?, ?, ?, "
        "?, ?, ?, ?, ?, ?, ?, "
	...
	/* Limite de points d'arène quotidiens - By MacWarrior */
	uberInsert.addUInt32(GetArenaPointsSinceLastReset());
	/* Limite de points d'arène quotidiens - By MacWarrior */
